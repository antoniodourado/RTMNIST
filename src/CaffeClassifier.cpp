...
CaffeClassifier::CaffeClassifier() {
	...
	const string model_file = "Assets/deploy.prototxt";
	const string trained_file = "Assets/model.caffemodel";
	const string label_file = "Assets/labels.txt";
	const string mean_file = "Assets/mean.binaryproto";
